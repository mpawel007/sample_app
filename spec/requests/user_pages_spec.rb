  ...
  describe "profile page" do
    ...
    describe "follow/unfollow buttons" do
      ...
      describe "following a user" do
        ...
        it "should increment user following count" do
          expect do
            click_button "Follow"
          end.to change( user.followed_users, :count).by(1)
        end

        it "should increment other user followers count " do
          expect do
            click_button "Follow"
      ...
      describe "unfollowing a user" do
        ...
        it "should decrement user following count" do
          expect do
            click_button "Unfollow"
          end.to change( user.followed_users, :count).by(-1)
        end

        it "should decrement other user followers count " do
          expect do
            click_button "Unfollow"
          end.to change( other_user.followers, :count).by(-1)
        end
